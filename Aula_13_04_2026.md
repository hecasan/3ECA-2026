# Aula 13/04/2026 - Componentização em React Native
...
```
AULA 1 (03/03/2026) — MVP Inicial
├── App.tsx (tudo em um arquivo)
├── useState básico
└── Interface funcional

AULA 2 (10/03/2026) — TypeScript Integrado
├── src/types/
├── src/interfaces/
├── Modelagem completa do domínio
└── Objetos tipados no App.tsx

AULA 3 (17/03/2026) — Componentização ← VOCÊ ESTÁ AQUI!
├── src/components/
│   ├── ConsultaCard.tsx
│   └── index.ts
